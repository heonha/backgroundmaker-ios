...
class MainWallpaperViewController: UIViewController {
    ...
    private lazy var editButton: UIBarButtonItem = {
        let barBtn = CocoaViewBuilder.shared.makeBarButtonWithSystemImage(systemName: "list.bullet.circle", selector: #selector(editButtonTapped), target: self)
        return barBtn
    }()
    ...
    private func configureLoadingIndicator() {
        ...
        CocoaViewBuilder.shared.addBlurToView(targetView: loadingIndecatorView)
    ...
    private func makeMenuView(title: String, image: UIImage, action: Selector) -> UIView {
        ...
        let bgView: UIView = {
            ...
            CocoaViewBuilder.shared.makeLayerShadow(to: view.layer)
            return view
        }()
