...
class CoreData {
    ...
    lazy var persistentContainer: NSPersistentContainer = {
         ...
         */
        let storeURL = URL.storeURL(for: Constant.appGroupID, databaseName: Constant.coreDataEntityName)
        let storeDescription = NSPersistentStoreDescription(url: storeURL)
        let container = NSPersistentContainer(name: Constant.coreDataEntityName)
